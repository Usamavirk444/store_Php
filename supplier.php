<?php
  ...
  if (isset($_POST['submit'])) {
      ...
      $sup_dec=mysqli_real_escape_string($conn,$_POST['sup_des']);
      $sup_sql="INSERT INTO `supplier`(`supplier_name`, `supplier_email`, `supplier_des`) VALUES ('$sup_name','$sup_email','$sup_dec')";
      $sup_fire=mysqli_query($conn,$sup_sql);
      if ($sup_fire) {
          ?>
                                ...
                                <div class="card">
                                    <form method="post">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                <label>Supplier Descrition</label>
                                                <input type="text" name="sup_des" class="form-control" required="">
                                            </div>
