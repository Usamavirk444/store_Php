<?php
  ...
  if (isset($_POST['submit'])) {
      $s_cat=mysqli_real_escape_string($conn,$_POST['scat']);
      $s_name=mysqli_real_escape_string($conn,$_POST['sname']);
      $s_dec=mysqli_real_escape_string($conn,$_POST['sdec']);
      $s_sql="INSERT INTO `sub_catageory`(`sub_cat`, `sub_name`, `sub_des`) VALUES ('$s_cat','$s_name','$s_dec')";
      $s_fire=mysqli_query($conn,$s_sql);
      if ($s_fire) {
          ?>
                                ...
                                <div class="card">
                                    <form method="post">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <select class="form-control" name="scat" id="">
                                        ...
                                        ?>
                                            ...
                                            <div class="form-group">
                                                <label>Sub Catageory Name</label>
                                                <input type="text" name="sname" class="form-control" required="">
                                            </div>
                                            <div class="form-group">
                                                <label>Descrition</label>
                                                <input type="text" name="sdec" class="form-control" required="">
                                            </div>
