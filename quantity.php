<?php
  ...
  if (isset($_POST['submit'])) {
      ...
      $q_unit=mysqli_real_escape_string($conn,$_POST['q_unit']);
      $q_sql="INSERT INTO `quantity`(`q_name`, `q_unit`) VALUES ('$q_name','$q_unit')";
      $q_fire=mysqli_query($conn,$q_sql);
      if ($q_fire) {
          ?>
                                    ...
                                    <form method="post">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="q_unit" class="form-control" required="">
                                            </div>
